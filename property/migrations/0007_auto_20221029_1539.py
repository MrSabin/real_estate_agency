# Generated by Django 2.2.24 on 2022-10-29 12:39
...
class Migration(migrations.Migration):
    dependencies = [
        ('property', '0006_auto_20221023_0905'),
    ]
            ...
            fields=[
                ...
                ('normalized_number',
                 phonenumber_field.modelfields.PhoneNumberField(blank=True, max_length=128, region=None,
                                                                verbose_name='Нормализованный номер владельца')),
                ('owned_flats', models.ManyToManyField(related_name='flat_owner', to='property.Flat',
